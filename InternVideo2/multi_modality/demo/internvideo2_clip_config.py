...
model = dict(
    ...
    tokenizer_path="/weka/home-meng/repos/InternVL/clip_benchmark/clip_benchmark/models/internvl_c_pytorch/chinese_alpaca_lora_7b",
    vision_ckpt_path="/weka/home-meng/hf_repos/InternVideo2-Stage2_1B-224p-f4/InternVideo2-stage2_1b-224p-f4.pt",
    load_vision_ckpt_from_internvideo2_stage2=True,
    text_ckpt_path="/weka/home-meng/hf_repos/InternVL/internvl_c_13b_224px.pth",
)
